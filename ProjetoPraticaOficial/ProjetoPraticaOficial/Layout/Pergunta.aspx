<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Base.master" AutoEventWireup="true" CodeFile="Pergunta.aspx.cs" Inherits="Contato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="faq">
        ...
        <div class="conteudo">
            <p>
                O primeiro passo para conseguir pagar online é verificar se os dados do cartão estão cadastrados corretamento no site. Se estiver tudo certo, pedimos que você entre em contato com a emissora do cartão para entender se existe algum problema. Caso esteja tudo correto e , ainda assim, você não conseguir pagar online, pedimos que entre em contato com a gente.<br />
                <br />
        ...
        <div class="conteudo">
            <p>
                Para solicitar estorno de uma cobrança indevida, pedimos que envie uma mensagem pra gente contendo os dados do pedido e, principalmente, o comprovante de cobrança. Assim, com essas informações em mãos, poderemos entender seu caso e providenciar o estorno do valor cobrado indevidamente.
                <br />
                <br />
                Ainda precisa de ajuda?
                <br />
